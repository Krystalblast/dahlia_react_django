...
urlpatterns = [
    ...
    path('remove_message/<int:message_id>', MessagesView.remove_message, name='remove_message'),
    # path('remove_messages/<int:friend_id>/<int:user_id>', MessagesView.remove_messages, name='remove_messages'),
